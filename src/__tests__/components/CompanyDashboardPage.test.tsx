...
describe('CompanyDashboardPage Component', () => {
  
  it('renders without crashing', async () => {
    let container;
    await act(async () => {
      const result = render(<CompanyDashboardPage companyCode="TST" companyName="Test Co" companyDesc="Test Description" />);
  ...
  it('has a valid React element type', async () => {
    expect(typeof CompanyDashboardPage).toBe('function');
  });
